    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-3">
                ...
                <p>Votre partenaire incontournable du laboratoire en Algérie. Importation et distribution de matériels et consommables de laboratoire depuis plus de 20 ans.</p>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="tel:+213123456789" class="text-white-50 text-decoration-none"><i class="fas fa-phone"></i> +213 (0) 123 456 789</a></li>
                    <li><a href="mailto:contact@vep.dz" class="text-white-50 text-decoration-none"><i class="fas fa-envelope"></i> contact@vep.dz</a></li>
                    <li class="text-white-50"><i class="fas fa-map-marker-alt"></i> Alger, Algérie</li>
                </ul>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="text-white-50 small mb-0">&copy; <?php echo date('Y'); ?> VEP - Tous droits réservés.</p>
            </div>
